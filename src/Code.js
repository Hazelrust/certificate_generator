...
const TEMPLATE_SLIDE_ID = 'YOUR SLIDE ID'; // ID ของ Google Slides template
/** ใส่ ID ของโฟลเดอร์ที่จะเอาไปเก็บไฟล์ (อย่าลืมเปิดแชร์)*/
const OUTPUT_FOLDER_ID = 'YOUR GOOGLE DRIVE FOLDER ID'; // ID ของโฟลเดอร์ที่จะเก็บไฟล์ (ถ้าไม่ระบุจะเก็บใน root)

/** ใน slide ใส่อะไรให้เขียนแบบนั้น เช่น <<ชื่อสกุล>> */
const PLACEHOLDERS = {
  NAME: '<<ชื่อสกุล>>',
};
